...
<html lang="en">
  ...
  <body>
    ...
    <div id="preloader">
      <div id="status">
        <img alt="logo" src="images/broos.png">
      </div>
    </div>
    <!--/.PRELOADER END-->
      ...
      <div class="content">
              ...
              <div class="owl-carousel2">
                <div class="col-md-12">
                  <div class="wrap-about">
                    <div class="w-content">
                      <p class="head-about">
                        For me Montreal will always be the best place for bagels, but we’re hoping that Edinburgh becomes a close second!

                        By working closely with Breadshare on a recipe that stays true to their ethos of using organic ingredients and distinctive local products as well as satisfying my incredible hunger for the perfect bagel; Bross Bagels aims to bring authentic bagels to Edinburgh and beyond.
                      </p>
        ...
        <section class="grey-bg mar-tm-10" id="menu">
          <div class="container">
              ...
              <div class="row">
              <div class="col-bg-6 col-bg-offset-3">
                <!--PORTFOLIO IMAGE-->
                <ul class="portfolio-image">
                  <li class="col-md-6">
                    <a href="images/salmon_bagel.jpg"><img alt="image" src="images/salmon_bagel.jpg">
                  ...
                  <li class="col-md-6">
                    <a href="images/bigapplebagel.jpg"><img alt="image" src="images/bigapplebagel.jpg">
                      <div class="decription-wrap">
                        <div class="image-bg">
                          <p class="desc">
                            Big Apple - £5.00
                  ...
                  <li class="col-md-6">
                    <a href="images/mamabross.jpg"><img alt="image" src="images/mamabross.jpg">
                      <div class="decription-wrap">
                        <div class="image-bg">
                          <p class="desc">
                            Mamma Bross - £5.00
                  ...
                  <li class="col-md-6">
                    <a href="images/pizaabagel.jpg"><img alt="image" src="images/pizaabagel.jpg">
                      <div class="decription-wrap">
                        <div class="image-bg">
                          <p class="desc">
                           Pizza Bagel - £5.00
              ...
              <div class="col-md-10 col-md-offset-1">
                <div class="owl-carousel">
                  ...
                  <div class="list-testimonial">
                    <div class="content-testimonial">
                      <h3 class="testi">
                        “ Another successful project working with c He has great design skills, is very responsive and professional. Looking forward to the next opportunity to work together. ”
                      </h3>
                      <p class="people">
                        Marko Milicevic
                      </p>
       ...
       <!--  <section class="grey-bg" id="blog">
        ...
        <footer>
          ...
          <div class="footer-bottom">
            <div class="container">
              <div class="row">
                <img src="images/brooscopy.png" alt="logo bottom" class="center-block" />
              </div>
            </div>
          </div>
        </footer>
